...
- Ссылка на **альбом Spotify или Apple Music** показывает список треков с инлайн-кнопками: можно взять отдельный трек или скачать весь альбом. Плейлисты пока не поддерживаются
