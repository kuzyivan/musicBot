...
- Ссылка на **альбом Spotify** показывает список треков с инлайн-кнопками: можно взять отдельный трек или скачать весь альбом. Плейлисты пока не поддерживаются
